        ...
        public void CreateSampleShippingOptions()
        {
            var shippings = new Dictionary<string, ShippingBase>
            {
                ...
                },
                {
                    ...
                    {
                        CustomShippingCosts = new List<CustomShippingCost>
                        {
                            new CustomShippingCost{DestinationRegion = CustomShippingCost.Regions.UK, Amount = .5m},
                            new CustomShippingCost{DestinationRegion = CustomShippingCost.Regions.Europe, Amount = 1m},
                            new CustomShippingCost{DestinationRegion = CustomShippingCost.Regions.RestOfTheWorld, Amount = 2m},
                        }
                    }
                }
            };
