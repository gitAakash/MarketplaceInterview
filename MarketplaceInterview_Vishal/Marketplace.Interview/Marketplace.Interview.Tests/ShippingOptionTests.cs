...
namespace Marketplace.Interview.Tests
{
    ...
    public class ShippingOptionTests
    {
        ...
        [Test]
        public void AnotherShippingTypeTest()
        {
            ...
            var lineItemList = new List<LineItem>
            {
                new LineItem
                {
                    Amount = 1.5m,
                    ProductId = "1",
                    Shipping = shippingOptions["AnotherShippingType"],
                    SupplierId = 1,
                    DeliveryRegion = AnotherShippingTypeCost.Regions.Europe,
                    ShippingAmount = 1m
                },
                new LineItem
                {
                ...
                new LineItem
                {
                    ...
                    Shipping = shippingOptions["AnotherShippingType"],
                    SupplierId = 1,
                    DeliveryRegion = AnotherShippingTypeCost.Regions.UK,
                    ShippingAmount = 0.5m
                },
                new LineItem
                {
                ...
                new LineItem
                {
                    ...
                    Shipping = shippingOptions["AnotherShippingType"],
                    SupplierId = 1,
                    DeliveryRegion = AnotherShippingTypeCost.Regions.RestOfTheWorld,
                    ShippingAmount = 2m
                },
                new LineItem
                {
