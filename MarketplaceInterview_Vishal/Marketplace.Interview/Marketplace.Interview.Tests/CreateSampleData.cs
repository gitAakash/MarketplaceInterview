    ...
    public class CreateSampleData
    {
        ...
        public void CreateSampleShippingOptions()
        {
            var shippings = new Dictionary<string, ShippingBase>
            {
                ...
                {
                    "AnotherShippingType", new AnotherShippingType
                    {
                        AnotherShippingTypeCosts = new List<AnotherShippingTypeCost>
                        {
                            new AnotherShippingTypeCost{DestinationRegion = AnotherShippingTypeCost.Regions.UK, Amount = .5m},
                            new AnotherShippingTypeCost{DestinationRegion = AnotherShippingTypeCost.Regions.Europe, Amount = 1m},
                            new AnotherShippingTypeCost{DestinationRegion = AnotherShippingTypeCost.Regions.RestOfTheWorld, Amount = 2m},
                        }
                    }
                }
            };
